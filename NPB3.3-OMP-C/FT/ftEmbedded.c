...
//---- Start of Setup from testNIDAQ_Cesar/main.c ----
...
int SAMPLES_PER_SEC = 1000;
int SAMPLING_SECS = 9;
int SAMPLES_PER_CHANNEL = 9000;
...
char        errBuff[2048]={'\0'};
*/
//---- End of Setup from testNIDAQ_Cesar/main.c ----
...
int main(int argc, char *argv[])
{
  ...
  finalize();
  */
  //takeMeasurements(1000, 9, "FT_Output.txt");
  ...
  //init("IP Address", "port"); //Test IP address and port values
...
static void init_ui(void *ou0, void *ou1, void *ot, int d1, int d2, int d3)
{
  ...
  */
  ...
  //takeMeasurements(1000, 9, "FT_Output.txt");
    ...
    //-- End of createAIVoltageChan --

    //-- Start of setSampleClockAndRate --
...
static void setup()
{
  ...
  printf("\n\n NAS Parallel Benchmarks (NPB3.3-OMP-C) - FT Benchmark w/ Changes\n\n");
