...
int CreateProfile(int sampling_rate, int sampling_time){

//-------- Beginning of Writing to Temporary File Example -----
//-----

    printf("Running CreateProfile() in ftHelper3.c\n");
  //printf("Starting tests of NIDAQ unit...\n");
  //printf("Using device: [%s]\n", DAQ_DEVICE);
  //printf("Using channels: [%s]\n", PHYS_CHANNELS);
  

  int SAMPLES_PER_SEC = sampling_rate;
  int SAMPLING_SECS = sampling_time;
